...
public:
	...
	double gama =1;
        ...
        NLOHMANN_DEFINE_TYPE_INTRUSIVE(Params,gama,speedcross,rightP1,rightP2,ringDirection,ringP1,ringP2,speedRing, speedLow, speedHigh, speedDown, speedBridge, speedSlowzone, speedGarage,
